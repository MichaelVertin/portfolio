		...
		<section className="py-16 px-4 border-t border-gray-100">
			<div className="max-w-2xl mx-auto">
				<motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center space-y-6">
					...
					<p className="text-gray-600">Interested in working together? Let&apos;s have a conversation.</p>
					...
					<div className="flex flex-col sm:flex-row justify-center gap-4">
						<a
							href="mailto:mikevertin64@example.com"
					...
					<div className="flex justify-center gap-6">
						<a href="https://github.com/MichaelVertin" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-900 transition-colors">
						...
						<a href="https://www.linkedin.com/in/michael-vertin-985b592b3/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-600 transition-colors">
							<svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
